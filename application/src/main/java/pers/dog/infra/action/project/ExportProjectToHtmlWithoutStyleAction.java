 ...
 */
@Component
public class ExportProjectToHtmlWithoutStyleAction extends Action {
    ...
    private ExportProjectToHtmlWithoutStyleAction() {
        super(I18nMessageSource.getResource("info.project.export.to-html-without-style"));
    ...
    public void saveProject(ActionEvent event) {
        ((ProjectEditorController) projectEditorWorkspace.get().getSelectionModel().getSelectedItem().getUserData()).exportToHtmlWithoutStyle();
    }
}
